...
| --- | --- | --- |
| [`sbom-diff-and-risk`](tools/sbom-diff-and-risk/README.md) | Released at `v0.7.0` | Deterministic SBOM/dependency diffing, JSON/Markdown/SARIF output, local policy checks, optional provenance and Scorecard evidence. |
...
- [v0.7.0 release notes](tools/sbom-diff-and-risk/RELEASE_NOTES_v0.7.0.md)
...
3. Check the [v0.7.0 release notes](tools/sbom-diff-and-risk/RELEASE_NOTES_v0.7.0.md).
